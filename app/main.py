...
def clean_settings_payload(payload: dict[str, Any]) -> dict[str, Any]:
    numeric_ranges = {
        ...
        "threshold_breach_exit_buffer_dollars": (-100_000.0, 100_000.0),
        ...
        "paper_texas_holdem_v2_mvi_minimum": (0.0, 10.0),
        "demo_texas_holdem_v2_mvi_minimum": (0.0, 10.0),
        "live_texas_holdem_v2_mvi_minimum": (0.0, 10.0),
        "paper_texas_holdem_v21_realized_volatility_gate_pct": (0.0, 100.0),
        "demo_texas_holdem_v21_realized_volatility_gate_pct": (0.0, 100.0),
        "live_texas_holdem_v21_realized_volatility_gate_pct": (0.0, 100.0),
        "paper_texas_holdem_v21_realized_volatility_boost_pct": (0.0, 100.0),
        "demo_texas_holdem_v21_realized_volatility_boost_pct": (0.0, 100.0),
        "live_texas_holdem_v21_realized_volatility_boost_pct": (0.0, 100.0),
        "paper_texas_holdem_v21_realized_volatility_boost_multiplier": (1.0, 5.0),
        "demo_texas_holdem_v21_realized_volatility_boost_multiplier": (1.0, 5.0),
        "live_texas_holdem_v21_realized_volatility_boost_multiplier": (1.0, 5.0),
    ...
    for key, value in payload.items():
        ...
        if key in numeric_ranges:
            ...
            "directional_momentum_gate_enabled",
